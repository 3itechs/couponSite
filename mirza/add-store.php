      ...
      <section class="panel clearfix" style="padding-bottom:20px;">
         ...
         <div class="adv-table addstore text-center" >         
          <div class="dataTables_wrapper">
            <form class="form" role="form" method="post" action="ajax/add-store-process.php" enctype="multipart/form-data">              
              <div class="form-group">
               ...
               <div class="form-group">       
                  ...
                  <input  class="form-control m-bot5" type="text" name="storename" id="storename" value="<?php echo $storename;?>" placeholder="Store Name" >
               </div>
                ...
                <div class="form-group">       
                  ...
                  <select id="network_id" name="network_id" class="form-control m-bot5" required>
                    <option value="">--Select Network*--</option>
                      <?php	while(list($network_id,$networkname)=$db->FetchAsArray($rs_sql)) {?>
                         <option value="<?php echo $network_id; ?>" ><?php echo $networkname; ?></option>
                      <?php }?>
                  </select>
                  </div>
                 ...
                 <textarea rows="2" class="form-control m-bot5" id="tracking_slink" name="tracking_slink" placeholder="Tracking Link*" required></textarea>
                 </div>
                 ...
                 <?php /*?><div class="form-group">       
                  <label class="control-label pull-left">Video Url 1</label>
                 <input  class="form-control m-bot5" type="text" name="store_video1"  value="<?php echo $store_video1;?>" placeholder="https://www.youtube.com/embed/PekR0L2Vkhk">
                 </div>
                 
                 <div class="form-group">       
                  <label class="control-label pull-left">Video Url 2</label>
                 <input  class="form-control m-bot5" type="text" name="store_video2"  value="<?php echo $store_video2;?>" placeholder="https://www.youtube.com/embed/PekR0L2Vkhk">
                 </div><?php */?>
                 
                 <div class="col-lg-8 m-bot15 text-left">
                  <label class="checkbox-inline">
                      <input type="checkbox" id="top" name="top" value="1"> Top
                  </label>
                  <label class="checkbox-inline">
                      <input type="checkbox" id="feature" name="feature" value="1"> Propular
                  </label>
                 </div> 
                 ...
                 <div class="form-group">       
                  ...
                  <div class="col-sm-3 col-xs-12">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                          ...
                          <div class="fileupload-preview fileupload-exists logo" style="max-width: 100px; max-height: 100px; line-height: 20px;"></div>
                          <div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">       
                  <label class="control-label pull-left">Store Thumb Alt</label>      
                   <input  class="form-control m-bot5" type="text" name="store_thumbnail_alt" value="" placeholder="Store Thumb Alt" >
               </div>
               ...
               <div class="form-group">       
                  <label class="control-label pull-left">Meta Title</label>
                        ...
                        <textarea rows="2" class="form-control m-bot5" id="meta_title" name="meta_title" placeholder="Meta Title" ></textarea>
                  </div>      
                  <div class="form-group">       
                 ...
                 <?php /*?><div class="form-group">       
                  <label class="control-label pull-left">Video Url 3</label>
                 <input  class="form-control m-bot5" type="text" name="store_video3"  value="<?php echo $store_video3;?>" placeholder="https://www.youtube.com/embed/PekR0L2Vkhk">
                 </div>
                 
                 <div class="form-group">       
                  <label class="control-label pull-left">Video Url 4</label>
                 <input  class="form-control m-bot5" type="text" name="store_video4"  value="<?php echo $store_video4;?>" placeholder="https://www.youtube.com/embed/PekR0L2Vkhk">
                 </div><?php */?>
               ...
               <div class="form-group">       
                  ...
                  <textarea rows="2" class="form-control m-bot5" id="editor" name="store_desc" placeholder="Store Description"></textarea>
                </div>
               ...
               <div class="form-group" style="height:30px"> </div>
                <div class="form-group">       
                  ...
                  <textarea rows="2" class="form-control m-bot5" id="editor2" name="more_about_desc" ></textarea>
                </div>
             ...
             <div class="form-group input_fields_wrap"> </div>
                 ...
                 <div class="col-sm-12 col-xs-12">
                      <button type="submit" class="btn btn-danger pull-right">Add New</button>
                  </div>
               </div> 
