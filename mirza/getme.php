...
function twitter_user_info($screen_name){
    ...
    $data = file_get_contents("https://twitter.com/search?q=" . $screen_name);
...
$api_page = 'http://twitter.com/' . $username;
...
return strval ( $count );
 ...
 print twitter_followers_counter('massmediagroup');
...
$store_orig_url = 'http://www.target.com';

$obj = new SocialCount($store_orig_url); 



echo $obj->get_fb();
echo "<br/>";
echo getTweets($store_orig_url);
echo "<br/>..";
//echo $obj->get_tweets();
echo "<br/>";
