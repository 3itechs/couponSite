...
$pageTitle = 'Update Page Info';
$pageHeading = 'Update Page Info'; 
$fname = 'update-static-page.php'; 
      ...
      <section id="main-content">
         ...
         <div class="adv-table text-center" >         
          <div class="dataTables_wrapper">
           ...
           <form name="edit_page" class="form" role="form" method="post" action="ajax/update-static-page-process.php" enctype="multipart/form-data" >             
             ...
             <div class="form-group">
              ...
              <div class="form-group">       
                  ...
                  <textarea rows="2" class="form-control m-bot5" id="editor"  name="pdesc" placeholder="Description" ><?php echo  $pdesc ;?></textarea>
             </div>
