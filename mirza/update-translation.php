...
$pageHeading = 'Update Translation'; 
$fname = 'update-translation.php'; 
 
if(isset($_REQUEST['id'])){$id=$_REQUEST['id'];}
 $db->ExecuteQuery("set sql_big_selects=1");  
  $sqlcategorys = "SELECT pid, ptitle, pdesc, meta_title,  meta_desc, meta_keywords, added_date, status FROM translation WHERE pid=".$id; 
      ...
      <section id="main-content">
         ...
         <div class="adv-table text-center" >         
          <div class="dataTables_wrapper">
           ...
           <form name="edit_page" class="form" role="form" method="post" action="ajax/update-translation-process.php" enctype="multipart/form-data" >             
             ...
             <div class="form-group">
              ...
              <div class="form-group"><div class="col-xs-12">&nbsp;</div></div>
              
             <div class="form-group">       
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                        
                    <a href="popups/add-translation-img-popup.php" class="btn btn-success pull-right" data-toggle="modal" data-target="#myAddModal">Upload  Image</a>
              ...
              <div class="form-group">              
               <div class="col-xs-12">        
                  ...
                  <textarea rows="2" class="form-control m-bot5" id="editor"  name="pdesc" placeholder="Description" ><?php echo  $pdesc ;?></textarea>      </div>
             </div>
