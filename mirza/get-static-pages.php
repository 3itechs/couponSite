...
$perpageresult = $perPage->perpage($_GET["rowcount"], $paginationlink); ?>
 ...
 while(list($page_id, $ptitle, $pdesc, $meta_title, $meta_desc, $meta_keywords, $added_date, $status) = $db->FetchAsArray($result))
    ...
    <tr id="tr-<?php echo $page_id; ?>">
        ...
        <a target="_blank" href="update-static-page.php?id=<?php echo $page_id; ?>" class="btnEditAction"  id="<?php echo $page_id; ?>" ><img src="img/edit.png"></a> <a href="#" id="<?php echo $page_id; ?>" class="btnDeleteAction" ><img src="img/delete.png"></a>
