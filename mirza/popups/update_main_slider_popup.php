...
if(isset($_REQUEST['sid'])){$sid=$_REQUEST['sid'];}
 ...
 $sqlusers = "SELECT sid, ms_title, ms_alt, ms_link, ms_img, status, added_date FROM main_slider WHERE sid=".$sid;
               
 $rs_user=$db->ExecuteQuery($sqlusers);            
 list($sid, $ms_title, $ms_alt, $ms_link, $ms_img, $status, $added_date)= $db->FetchAsArray($rs_user); ?>
       ...
       <section class="panel clearfix">
         ...
         <div class="adv-table text-center" >         
          <div class="dataTables_wrapper">
           <form name="edit_user" class="form" role="form" method="post" action="ajax/update-main-slider-process.php" enctype="multipart/form-data" >             
                                             ...
                                             <?php }else{?>                                              
                                              <div data-provides="fileupload" class="fileupload fileupload-exists"><input type="hidden" value="" name="">
                                                  <div style="width: 100px; height: 100px;" class="fileupload-new thumbnail">
                                                    <!-- <img src="../images/logos/<?php echo $ms_img;?>" alt="" />-->
                                                  </div>
                                                  <div style="max-width: 100px; max-height: 100px; line-height: 10px;" class="fileupload-preview fileupload-exists thumbnail">
                                                  
                                                  <img style="max-height: 100px;" src="<?php echo MAIN_SLIDER_PATH;?><?php echo $ms_img;?>" alt="" />
                                                  </div>
                                                  <div>
                                                    <span class="btn btn-white btn-sm btn-file">
                                                    <span class="fileupload-new"><i class="icon-paper-clip"></i> Select Image </span>
                                                    <span class="fileupload-exists"><i class="icon-undo"></i> Change</span>
                                                    <input type="file" class="default m-bot5" name="ms_img">
                                                   </span>
                                                      <a data-dismiss="fileupload" id="<?php echo $sid?>" class="btn btn-danger btn-sm fileupload-exists dellmsimg" href="#"><i class="icon-trash"></i> Remove</a>
                                                  </div>
                                              </div>
