...
if(isset($_REQUEST['id'])){$id=$_REQUEST['id'];}
 ...
 $sqlcategorys = "SELECT category_id, category, category_title, category_url, parent_id, category_desc, meta_title, meta_desc, meta_keywords, date_added, status FROM post_categories WHERE category_id=".$id;
     ...
     <section id="main-content">
      ...
      <!-- page start-->
       <section class="panel clearfix" style="padding-bottom:20px;">
         <header class="panel-heading modal-header"> Update Post Category </header>
         <div class="adv-table text-center" >         
          <div class="dataTables_wrapper">
           <form name="edit_category" class="form" role="form" method="post" action="ajax/update-post-category-process.php" enctype="multipart/form-data" >             
              ...
              <div class="form-group">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                 ...
                 <?php /*?> <label for="inputUser" class="pull-left">Category Type</label>
                  <select ="kwd_type" name="kwd_type" class="form-control m-bot5" >
                    <option <? if($kwd_type == 'categories'){echo "selected";} ?> value="categories">Categories</option>
                    <option <? if($kwd_type == 'products'){echo "selected";} ?> value="products">Products</option>
                    <option <? if($kwd_type == 'tags'){echo "selected";} ?> value="tags">Tags</option>
                  </select>
                  ...
                  <select ="parent_id" name="parent_id" class="form-control m-bot5" >
                  ...
                  <textarea rows="2" class="form-control m-bot5" ="category_desc" name="category_desc" placeholder="Keyword Description" ><?php echo $category_desc; ?></textarea>
