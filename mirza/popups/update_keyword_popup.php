...
if(isset($_REQUEST['id'])){$id=$_REQUEST['id'];}
 ...
 $sqlkeywords = "SELECT kwd_id, keyword, kwd_type, keyword_heading, url, parent_id, meta_title, keyword_desc, meta_desc, meta_keywords, date_added, status FROM keywords WHERE kwd_id=".$id;
               
 $rs_keyword=$db->ExecuteQuery($sqlkeywords);            
 list($kwd_id, $keyword_name, $kwd_type, $keyword_heading, $url, $parent_id, $keyword_desc, $meta_title, $meta_desc, $meta_keywords, $date_added, $status)=  $db->FetchAsArray($rs_keyword);
    ...
    <section id="main-content">
      ...
      <!-- page start-->
       <section class="panel clearfix" style="padding-bottom:20px;">
         <header class="panel-heading modal-header"> Update Keyword </header>
         <div class="adv-table text-center" >         
          <div class="dataTables_wrapper">
           <form name="edit_keyword" class="form" role="form" method="post" action="ajax/update-keyword-process.php" enctype="multipart/form-data" >             
              <input  type="hidden" name="keywordid" value="<?php echo $kwd_id;?>" > 
