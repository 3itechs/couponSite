   ...
   <section id="main-content">
    <section class="wrapper">
      ...
      <section class="panel clearfix" style="padding-bottom:20px;">
        <header class="panel-heading modal-header"> Add Category </header>
        <div class="adv-table addstore text-center" >
          <div class="dataTables_wrapper">
            <form name="add_category" class="form" role="form" method="post" action="ajax/add-category-process.php" enctype="multipart/form-data"> 
