...
<script src="<?=DOMAINVAR?>/js/common-scripts.js"></script>
 ...
 <script type="text/javascript">	
	...
	function getresult(url) {  <!--$('#loading').html('<img src="img/loader.gif"> loading...').fadeIn(); -->
	...
	$.ajax({
		...
		data:  {rowcount:$("#rowcount").val(),dsort:$("#dsort").val(),couponid:$("#coupon_id").val(),sname:$("#sname").val(),cname:$("#couponname").val(),status:$("#status").val(),category:$("#primary_category").val() ,adsdate:$("#ad-sdate").val(), adedate:$("#ad-edate").val(), upsdate:$("#up-sdate").val(), upedate:$("#up-edate").val() },
