...
$db= new DB(); 
$fname = 'static-pages.php'; 
$pageTitle = 'Manage Page';
$pageHeading = 'List Page';
$pageString = 'Page'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <section class="wrapper">
              ...
              <header class="panel-heading" style="padding:15px 0 45px;"> <div class="col-md-10 col-ms-10 col-xs-6"><?php echo $pageHeading;?></div>                 
                  <div class="col-md-2 col-ms-2 col-xs-6">
                  	<a href="add-static-page.php" class="btn btn-success" >Add New</a>
                  </div>
                  </header>                    
...
<script src="<?=DOMAINVAR?>/js/common-scripts.js"></script>
 ...
 <script type="text/javascript">	
	...
	$(document).on('click', '#btnSearch', function(){ getresult("get-static-pages.php"); });
	  
	getresult("get-static-pages.php");	
  ...
  $(document).on('click', '.btnDeleteAction', function(){
    var id = $(this).attr('id');
	  if(confirm('Are you sure to delete it?'))
	    {
	     $.ajax({
			 url: "ajax/dell-static-page.php?id="+id,
			 type: "POST",
