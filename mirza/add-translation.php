...
$pageHeading = 'Add Translation'; 
$fname = 'add-translation.php'; 
          ...
          <div class="dataTables_wrapper">
           <?php if ($_REQUEST['u'] == 1){?>
                        <div class="alert alert-success fade in">
                          ...
                          <strong>!</strong>Info updated successfully.
           </div><?php } ?>
           <form name="edit_page" class="form" role="form" method="post" action="ajax/add-translation-process.php" enctype="multipart/form-data" >             
