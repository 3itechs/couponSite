...
if($category_name != ''){
   $insert = "INSERT INTO categories ( category, category_title, parent_id, category_url, img, category_desc,  meta_title, meta_desc, meta_keywords, status, date_added) VALUES (  
  ...
  // echo $insert ;  die;
   header("location: ../categories.php?a=1"); exit;  					
}
	  
}header("location: ../categories.php?a=2"); exit;
