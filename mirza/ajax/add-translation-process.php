...
if($ptitle != ''){
   $insert = "INSERT INTO translation ( ptitle, pdesc,  meta_title, meta_desc, meta_keywords, status, added_date) VALUES ( '$ptitle', '$pdesc', '$meta_title', '$meta_desc', '$meta_keywords', '$status', now())";
   $rs_insert = $db->ExecuteQuery($insert);
  // echo $insert ;  die;
   header("location: ../translation.php?a=1"); exit;  					
}
	  
}header("location: ../translation.php?a=2"); exit;
