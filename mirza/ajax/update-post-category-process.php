...
$sqlUpdate = "UPDATE post_categories SET category = '$category_name', parent_id = '$parent_id', category_title = '$category_title', category_url = '$category_url', "; 
...
$sqlUpdate .="  WHERE category_id='$kwdid'";	
 ...
 header("location: ../post-categories.php?u=1");
 exit;
 
}  header("location: ../post-categories.php?u=2"); exit;
?>
