...
<!--[if lt IE 9]>
  ...
  <section id="container" class="">
      ...
      <section class="panel clearfix" style="padding-bottom:20px;">
        <header class="panel-heading modal-header"> Add Coupon </header>
        <div class="adv-table addcoupon text-center" >
          <div class="dataTables_wrapper">
            <form class="form" role="form" method="post" action="ajax/add-coupon-process.php" enctype="multipart/form-data">              
              ...
              <div class="form-group">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                 ...
                 <label class="control-label pull-left">Coupon Title</label>
                    <input  class="form-control m-bot5" type="text" name="couponname" placeholder="Coupon Title*" required>
                 </div>

               <div class="form-group">
                 <label class="control-label pull-left">Coupon Description</label>
                    <textarea rows="2" class="form-control m-bot5" id="coupon_desc" name="coupon_desc" placeholder="Coupon Description*"></textarea> 
                </div>
              ...
              <div class="col-lg-8 m-bot15 text-left">
                 <label class="checkbox-inline">
                   <input type="checkbox" id="never_exp" name="never_exp" value="1"> Never Expire
                 </label>
             </div>
              ...
              <?php /*?><div class="form-group">              
                 ...
                 <div class="col-lg-8 m-bot15 text-left">
                  <label class="checkbox-inline">
                     <!-- <input type="checkbox" id="top" name="top" value="1"> Best Picks -->
                  </label>
                  <label class="checkbox-inline">
                      <input type="checkbox" id="feature" name="feature" value="1"> Show at Home Page
                  </label>
                 </div>                    
            ...
            <div class="form-group">
                 <label class="control-label pull-left">Select Category</label>
                    <select id="primary_category" name="primary_category" class="form-control m-bot5" required >
                        <option value="">--Primary Category*--</option>
                           <?
                             $sql="Select category_id, category from categories where 1   order by category  ";                 $rs_sql=$db->ExecuteQuery($sql); 
               ...
               <div class="form-group">
                 <label class="control-label pull-left">Tracking link</label>
                    <textarea rows="2" class="form-control m-bot5" id="tracking_link" name="tracking_link" placeholder="Tracking Link*" required></textarea>
               </div>
             ...
             <?php /*?><div class="form-group">
                       ...
                       <div class=" col-lg-3">  
                          <label class="control-label pull-left">Discount Value</label>
                          <input  class="form-control" type="text" name="discount_value" id="discount_value" value="<?php echo $discount_value;?>" > 
                       </div>
